...
import com.woobadeau.tinyengine.Thing;
import com.woobadeau.tinyengine.ThingMouseListener;
...
public class ColorManager extends Thing implements ThingMouseListener {
    ...
    protected void onCreate() {
        this.position = new Vector2D(300, 640);
    }

    @Override
    protected void draw(Graphics graphics) {
        graphics.setColor(color);
        graphics.fillOval(this.position.x, this.position.y, 100, 100);
    }
